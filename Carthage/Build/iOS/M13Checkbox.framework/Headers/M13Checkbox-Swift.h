...
SWIFT_MODULE_NAMESPACE_PUSH("M13Checkbox")
@class NSCoder;
@class UIColor;
...
/// The object to return from <code>value</code> when the checkbox is checked.
@property (nonatomic) id _Nullable checkedValue SWIFT_DEPRECATED_OBJC("Swift property 'M13Checkbox.checkedValue' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// The object to return from <code>value</code> when the checkbox is unchecked.
@property (nonatomic) id _Nullable uncheckedValue SWIFT_DEPRECATED_OBJC("Swift property 'M13Checkbox.uncheckedValue' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// The object to return from <code>value</code> when the checkbox is mixed.
@property (nonatomic) id _Nullable mixedValue SWIFT_DEPRECATED_OBJC("Swift property 'M13Checkbox.mixedValue' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Returns one of the three “value” properties depending on the checkbox state.
/// note:
/// This is a convenience method so that if one has a large group of checkboxes, it is not necessary to write: if (someCheckbox == thatCheckbox) { if (someCheckbox.checkState == …
///
/// returns:
/// The value coresponding to the checkbox state.
@property (nonatomic, readonly) id _Nullable value SWIFT_DEPRECATED_OBJC("Swift property 'M13Checkbox.value' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
///
- (void)toggleCheckState:(BOOL)animated SWIFT_DEPRECATED_OBJC("Swift method 'M13Checkbox.toggleCheckState(_:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
